"""
Django settings for light_prd_44509 project.
...
ROOT_URLCONF = 'light_prd_44509.urls'
...
WSGI_APPLICATION = 'light_prd_44509.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "light_prd_44509 API",
    "DESCRIPTION": "API documentation for light_prd_44509 App",
    "VERSION": "v1",
}
